...
from camera.models import (Camera, CameraHeartbeat,
                           ...
                           KitchenViolationReport, AGGFViolationReport, SmokingViolationReport, FaceDetectionReport, GarbageMonitoringReport, RecycleMonitoringReport, FallDetectionMonitoringReport, ViolenceMonitoringReport, CrowdMonitoringReport, WallClimbMonitoringReport, AbnormalActivities, BuffetViolationReport, BathroomMonitoringHistory, SentimentAnalysis, CameraStatus, CameraType, CleanersPresenceHistory)
